  ...
  return (
    ...
    <h2 className='text-4xl font-bold flex justify-center gap-4 text-transparent bg-clip-text bg-gradient-to-r from-[#373B44] to-[#4286f4] py-12'>Experience</h2>
      <div className="flex flex-wrap justify-center gap-4">
        <Card imageSource={'/images/computer.jpg'}>
          <h3 className='text-xl font-bold mb-2'>Dev ops Engineer Intern</h3> 
          <p>
        ...
        <Card imageSource={'/images/computer.jpg'}>
          <h3 className='text-xl font-bold mb-2'>Software Engineer Team Leader Intern</h3> 
          <p>
        ...
        <Card imageSource={'/images/compScience.jpg'}>
          <h3 className='text-xl font-bold mb-2'>Computing Science Teaching Assistant</h3> 
          <p>
